...
1:
	...
	.type	yuv420p_rgb565_neon, %function
yuv420p_rgb565_neon:
	stmdb sp!, {r4, lr}
	...
	vld1.u8	{ d0, d1 }, [r0]!	@ y is 0-255
	vst1.u8	{ d0, d1 }, [r2]!
	@vmov.u8		q6,#10      @ add a delta Y to increase Y
	@vqadd.u8 q0, q0, q6
	...
	vsub.s8 d4,d3,d6		@ u-= 128
	vsub.s8 d5,d3,d6
	vsub.s8	d3,d2,d6		@ v-= 128
	vsub.s8 d2,d2,d6
...
1:
	...
	vmull.s8	q12,d29,d4	@ u * 1.772
	vmull.s8	q13,d29,d5

	vmull.s8	q8,d28,d2	@ v * 1.402
	vmull.s8	q9,d28,d3
...
2:
	...
	vadd.s16	q8,q10		@ y + 1.402 * v
	vadd.s16	q9,q11
	vmlsl.s8	q10,d30,d4	@ y -= 0.34414 * u
	vmlsl.s8	q11,d30,d5
	vmlsl.s8	q10,d31,d2	@ y -= 0.71414 * v
	vmlsl.s8	q11,d31,d3
...
2:
	...
	@vqshlu.s16	q8,#3		@ red in upper 8 bits
	@vqshlu.s16	q9,#3
	@vqshlu.s16	q10,#3		@ green in upper 8 bits
	@vqshlu.s16	q11,#3
	@vqshlu.s16	q12,#3		@ blue in upper 8 bits
	@vqshlu.s16	q13,#3
